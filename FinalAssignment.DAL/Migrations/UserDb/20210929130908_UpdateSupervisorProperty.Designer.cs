...
namespace FinalAssignment.DAL.Migrations.UserDb
{
    ...
    [Migration("20210929130908_UpdateSupervisorProperty")]
    partial class UpdateSupervisorProperty
    {
            ...
            modelBuilder.Entity("FinalAssignment.DAL.Data.Models.Crew", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2021, 9, 29, 18, 39, 7, 914, DateTimeKind.Local).AddTicks(2856));
            ...
            modelBuilder.Entity("FinalAssignment.DAL.Data.Models.Employee", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 9, 29, 18, 39, 7, 913, DateTimeKind.Local).AddTicks(4401));
            ...
            modelBuilder.Entity("FinalAssignment.DAL.Data.Models.Minute", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 9, 29, 18, 39, 7, 914, DateTimeKind.Local).AddTicks(7943));
