...
namespace FinalAssignment.DAL.Migrations.UserDb
{
    ...
    [Migration("20210926163616_MinuteTableUpdate")]
    partial class MinuteTableUpdate
    {
            ...
            modelBuilder.Entity("FinalAssignment.DAL.Data.Models.Crew", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2021, 9, 26, 22, 6, 15, 890, DateTimeKind.Local).AddTicks(2684));
            ...
            modelBuilder.Entity("FinalAssignment.DAL.Data.Models.Employee", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 9, 26, 22, 6, 15, 889, DateTimeKind.Local).AddTicks(7427));
            ...
            modelBuilder.Entity("FinalAssignment.DAL.Data.Models.Minute", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 9, 26, 22, 6, 15, 890, DateTimeKind.Local).AddTicks(5793));
